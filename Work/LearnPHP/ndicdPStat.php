    ...
    <body>
        <div class="wrapper">
            <div class="wrapper1">
                <div>
                    <div class="address">&#x1F4CD; NDICD Building Udhyog Nagar, Naini, Prayagraj,Utter Pradesh, 211008
                    </div>
                    <div class="head">
                    ...
                    <div class="nav">
                        <ul class="nav-list">
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="ndicdAMission.php">Mission</a></li>
                                    <li><a href="ndicdATeam.php">Team</a></li>
                                    <li><a href="ndicdAHistory.php">History</a></li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="ndicdPStat.php">Placement Statistics</a></li>
                                    <li><a href="ndicdPProcess.php">Placement Process</a></li>
                                    <li><a href="ndicdPPartners.php">Placement Partners</a></li>
                                </ul>
                            </li>
                            <li>
                ...
                <div class="main">
                    <h1>Placement Statistics Data will be Availble Soon!</h1>
                </div>
                    ...
                    <div class="wrapper">
                        <div class="footer-content">
                            ...
                            <div class="footer-section" id="footer-section">
                                <h3>Follow Us</h3>
                                <ul>
                                    <li class="fla1"><a href="https://www.facebook.com/neeraj.jais"
                                            target="_blank">facebook <i class="fa fa-facebook"></i></a></li>&nbsp;
                                    <li class="fla2"><a href="https://www.instagram.com/ndicd.naini"
                                            target="_blank">Instagram <i class="fa fa-twitter"></i></a></li>&nbsp;
                                    <li class="fla3"><a href="#" target="_blank">Twitter <i
                                                class="fa fa-instagram"></i></a></li>&nbsp;
                                    <li class="fla4"><a href="#" target="_blank">LinkedIn <i
                                                class="fa fa-linkedin"></i></a></li>&nbsp;
                                    <li class="fla5"><a href="#" target="_blank">Youtube<i
